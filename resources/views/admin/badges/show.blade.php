                ...
                <div class="col-md-8">
                    <div class="card card-navy">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <br>
                                    <a
                                        href="{{ is_null($badge->created_by_user) ? '#' : route('admin.users.show', $badge->created_by_user->encrypted_id) }}">{{ is_null($badge->created_by_user) ? '' : $badge->created_by_user->f_name . ' ' . $badge->created_by_user->l_name }}</a>
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <a
                                        href="{{ is_null($badge->updated_by_user) ? '#' : route('admin.users.show', $badge->updated_by_user->encrypted_id) }}">{{ is_null($badge->updated_by_user) ? '' : $badge->updated_by_user->f_name . ' ' . $badge->updated_by_user->l_name }}</a>
                                </div>
                                <div class="col-md-3">
                        ...
                        <div class="card-footer d-flex justify-content-end">
                            ...
                            <a href="{{ route('admin.badges.edit', $badge->encrypted_id) }}"
