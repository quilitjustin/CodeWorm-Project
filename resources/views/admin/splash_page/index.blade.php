                            ...
                            <table id="data-table" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    @forelse ($splashs as $splash)
                                        <tr>
                                            <td>
                                                <a href="{{ route('admin.splash.show', $splash['id']) }}">
                                                    Version {{ $splash->id }}</a>
                                                @if ($loop->first)
                                            ...
                                            <td class="d-none d-md-table-cell text-center"><a
                                                    href="{{ is_null($splash->created_by_user) ? '#' : route('admin.users.show', $splash->created_by_user->encrypted_id) }}">{{ is_null($splash->created_by_user) ? '' : $splash->created_by_user->f_name . ' ' . $splash->created_by_user->l_name }}</a>
                                            </td>
                                            <td class="d-none d-xl-table-cell">
                                                <a class="text-link" href="{{ route('admin.splash.show', $splash['id']) }}">
