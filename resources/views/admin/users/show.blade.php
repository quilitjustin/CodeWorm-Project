                ...
                <div class="col-md-12">
                    <div class="card card-navy">
                                ...
                                <div class="tab-pane" id="settings">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <br>
                                            <a
                                                href="#">{{ is_null($user->created_by_user) ? '' : $user->created_by_user->f_name . ' ' . $user->created_by_user->l_name }}</a>
                                        </div>
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <a
                                                href="#">{{ is_null($user->updated_by_user) ? '' : $user->updated_by_user->f_name . ' ' . $user->updated_by_user->l_name }}</a>
                                        </div>
                                        <div class="col-md-3">
                        ...
                        <div class="card-footer d-flex justify-content-end">
                            ...
                            <a href="{{ route('admin.users.edit', $user->encrypted_id) }}"
                                class="btn btn-primary ml-2">Update</a>
                            <form class="ban d-inline" action="{{ route('admin.user.ban', $user->encrypted_id) }}"
                                method="POST">
                                @csrf
                                @method('PUT')
