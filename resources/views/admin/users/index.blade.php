                            ...
                            <table id="data-table" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    @forelse ($users as $user)
                                        <tr>
                                            <td>
                                                <a href="{{ route('admin.users.show', $user->encrypted_id) }}">
                                            ...
                                            <td class="d-none d-xl-table-cell">
                                                <a class="text-link" href="{{ route('admin.users.show', $user->encrypted_id) }}">
                                                    <i class="far fa-eye"></i> View</a>
                                                <a class="text-success" href="{{ route('admin.users.edit', $user->encrypted_id) }}">
