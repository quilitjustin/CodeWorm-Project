            ...
            <div class="row d-flex justify-content-center">
                <div class="col-md-8">
                    <div class="card card-navy">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <br>
                                    <a
                                        href="{{ is_null($proglang->created_by_user) ? '#' : route('admin.users.show', $proglang->created_by_user->encrypted_id) }}">{{ is_null($proglang->created_by_user) ? '' : $proglang->created_by_user->f_name . ' ' . $proglang->created_by_user->l_name }}</a>
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <a
                                        href="{{ is_null($proglang->updated_by_user) ? '#' : route('admin.users.show', $proglang->updated_by_user->encrypted_id) }}">{{ is_null($proglang->updated_by_user) ? '' : $proglang->updated_by_user->f_name . ' ' . $proglang->updated_by_user->l_name }}</a>
                                </div>
                                <div class="col-md-3">
                        ...
                        <div class="card-footer d-flex justify-content-end">
                            ...
                            <a href="{{ route('admin.proglangs.edit', $proglang->encrypted_id) }}"
                ...
                <div class="col-md-8">
                    <div class="card card-navy">
                        ...
                        <!-- /.card-body -->
                        <div class="card-footer d-flex justify-content-end">
                            <a href="{{ route('admin.stages.create') }}" class="btn btn-primary">Create New
                                Stage</a>
                        </div>
                        <!-- /.card-footer -->
                    </div>
