                ...
                <div class="col-md-8">
                    <div class="card card-navy">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <br>
                                    <a
                                        href="{{ is_null($bgim->created_by_user) ? '#' : route('admin.users.show', $bgim->created_by_user->encrypted_id) }}">{{ is_null($bgim->created_by_user) ? '' : $bgim->created_by_user->f_name . ' ' . $bgim->created_by_user->l_name }}</a>
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <a
                                        href="{{ is_null($bgim->updated_by_user) ? '#' : route('admin.users.show', $bgim->updated_by_user->encrypted_id) }}">{{ is_null($bgim->updated_by_user) ? '' : $bgim->updated_by_user->f_name . ' ' . $bgim->updated_by_user->l_name }}</a>
                                </div>
                                <div class="col-md-3">
                        ...
                        <div class="card-footer d-flex justify-content-end">
                            ...
                            <a href="{{ route('admin.bgims.edit', $bgim->encrypted_id) }}" class="btn btn-primary ml-2">Update</a>
