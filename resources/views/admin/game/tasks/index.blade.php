                            ...
                            <table id="data-table" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    @forelse ($tasks as $task)
                                        <tr>
                                            <td>
                                                <a href="{{ route('admin.tasks.show', $task->encrypted_id) }}">
                                                    {{ $task->name }}
                                                </a>

                                            </td>
                                            <td>
                                                <a href="{{ route('admin.proglangs.show', $task->proglang->encrypted_id) }}">
                                                    {{ $task->proglang->name }}
                                                </a>
                                            </td>
                                            <td
                                            ...
                                            <td class="d-none d-xl-table-cell">
                                                <a class="text-link" href="{{ route('admin.tasks.show', $task->encrypted_id) }}">
                                                    <i class="far fa-eye"></i> View</a>
                                                <a class="text-success"
                                                    href="{{ route('admin.tasks.edit', $task->encrypted_id) }}">
