        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 pb-4">
                    <a href="{{ route('admin.announcements.create') }}" class="btn btn-success">Create new Announcement</a>
                </div>
                <div class="col-12">
                    @forelse($announcements as $announcement)
                        <div class="card card-primary card-outline">
                            ...
                            <div class="card-footer">
                                ...
                                <a class="text-link" href="{{ route('admin.announcements.show', $announcement->encrypted_id) }}">
                                    <i class="far fa-eye"></i> View</a>
                                <a class="text-success"
                                    href="{{ route('admin.announcements.edit', $announcement->encrypted_id) }}">
