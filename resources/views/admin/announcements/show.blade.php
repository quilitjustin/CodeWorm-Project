                ...
                <div class="col-12">
                    <div class="card card-navy card-outline">
                        ...
                        <div class="card-body" style="">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <br>
                                    <a
                                        href="{{ is_null($announcement->created_by_user) ? '#' : route('admin.users.show', $announcement->created_by_user->encrypted_id) }}">{{ is_null($announcement->created_by_user) ? '' : $announcement->created_by_user->f_name . ' ' . $announcement->created_by_user->l_name }}</a>
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <a
                                        href="{{ is_null($announcement->updated_by_user) ? '#' : route('admin.users.show', $announcement->updated_by_user->encrypted_id) }}">{{ is_null($announcement->updated_by_user) ? '' : $announcement->updated_by_user->f_name . ' ' . $announcement->updated_by_user->l_name }}</a>
                                </div>
                                <div class="col-md-3">
                        ...
                        <div class="card-footer d-flex justify-content-end">
                            ...
                            <a href="{{ route('admin.announcements.edit', $announcement->encrypted_id) }}"
