            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('admin.cms.bgim.splash.index') }}"
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('admin.cms.bgim.login.index') }}"
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('admin.cms.bgim.leaderboards.index') }}"
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('admin.cms.bgim.play.index') }}"
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('admin.cms.bgim.announcement.index') }}"
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('admin.cms.bgim.stalk.index') }}"
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.cms.logo.index') }}"
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('admin.proglangs.index') }}"
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.bgims.index') }}"
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('admin.env.executor') }}"
