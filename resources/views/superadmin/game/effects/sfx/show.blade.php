                ...
                <div class="col-md-8">
                    <div class="card card-indigo">
                        ...
                        <div class="card-footer d-flex justify-content-end">
                            ...
                            <a href="{{ route('sfxs.edit', $sfxuser->encrypted_id) }}" class="btn btn-primary ml-2">Update</a>
                            <form class="delete d-inline" action="{{ route('sfxs.destroy', $sfxuser->encrypted_id) }}" method="POST">
                                @csrf
                                @method('DELETE')
