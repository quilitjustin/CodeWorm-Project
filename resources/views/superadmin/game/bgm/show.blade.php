                ...
                <div class="col-md-8">
                    <div class="card card-indigo">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <br>
                                    <a href="{{ route('bgms.show', $bgm['created_by']) }}">{{ $bgm['created_by'] }}</a>
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <a
                                        href="{{ is_null($bgm['updated_by']) ? '#' : route('bgms.show', $bgm['updated_by']) }}">{{ $bgm['updated_by'] }}</a>
                                </div>
                                <div class="col-md-3">
                        ...
                        <div class="card-footer d-flex justify-content-end">
                            ...
                            <form class="d-inline" action="{{ route('bgms.destroy', $bgm['id']) }}" method="POST"
