                ...
                <div class="col-md-8">
                    <div class="card card-indigo">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <br>
                                    <a
                                        href="{{ is_null($bgm->created_by_user) ? '#' : route('users.show', $bgm->created_by_user->encrypted_id) }}">{{ is_null($bgm->created_by_user) ? '' : $bgm->created_by_user->f_name . ' ' . $bgm->created_by_user->l_name }}</a>
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <a
                                        href="{{ is_null($bgm->updated_by_user) ? '#' : route('users.show', $bgm->updated_by_user->encrypted_id) }}">{{ is_null($bgm->updated_by_user) ? '' : $bgm->updated_by_user->f_name . ' ' . $bgm->updated_by_user->l_name }}</a>
                                </div>
                                <div class="col-md-3">
                        ...
                        <div class="card-footer d-flex justify-content-end">
                            ...
                            <form class="delete d-inline" action="{{ route('bgms.destroy', $bgm->encrypted_id) }}"
                                method="POST">
                                @csrf
                                @method('DELETE')
