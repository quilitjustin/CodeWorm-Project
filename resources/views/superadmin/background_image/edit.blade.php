...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Edit Background Image</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-md-8">
                    <div class="card card-indigo">
                        ...
                        <form method="POST" action="{{ route('bgims.update', $bgim['id']) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <span class="text-sm text-danger">Note: only upload image if you want to update the picture</span>
                                            @error('image')
                                                <p class="text-danger my-2">{{ $message }}</p>
                                            @enderror
                                        </div>
