...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                     <h1 class="m-0 text-navy font-weight-bold d-inline mr-1">Stalk Background Image</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
...
@section('script')
    ...
    <script>
        const index_route = "{{ route('super.cms.bgim.stalk.index') }}";
        const route = "{{ route('super.cms.bgim.stalk.set') }}";
    </script>
