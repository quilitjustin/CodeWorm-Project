...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                     <h1 class="m-0 text-navy font-weight-bold d-inline mr-1">Badges</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-md-8">
                    <div class="card card-navy">
                        ...
                        <form method="POST" action="{{ route('super.badges.store') }}" enctype="multipart/form-data">
                            @csrf
                            <!-- /.card-header -->
                            <div class="card-body">
                                <div class="row">
                            ...
                            <div class="card-footer d-flex justify-content-end">
                                <a href="{{ route('super.badges.index') }}" class="btn btn-warning">Cancel</a>
