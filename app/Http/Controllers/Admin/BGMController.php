...
class BGMController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.game.bgm.index', [
            'bgms' => $bgms,
        ]);
    }
    ...
    {
        //
        return view('admin.game.bgm.create');
    }
    ...
    public function show($bgm)
    {
        ...
        return view('admin.game.bgm.show', [
            'bgm' => $data,
        ]);
    }
    ...
    public function edit($bgm)
    {
        ...
        return view('admin.game.bgm.edit', [
            'bgm' => $data,
        ]);
    }
