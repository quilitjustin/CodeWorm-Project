...
class SoundEffectController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.game.effects.sfx.index', [
            'sfxs' => $sfxs,
        ]);
    }
    ...
    {
        //
        return view('admin.game.effects.sfx.create');
    }
    ...
    public function show($sfx)
    {
        ...
        return view('admin.game.effects.sfx.show', [
            'sfx' => $data,
        ]);
    }
    ...
    public function edit($sfx)
    {
        ...
        return view('admin.game.effects.sfx.edit', [
            'sfx' => $data,
        ]);
    }
