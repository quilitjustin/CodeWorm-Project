...
class CMSController extends Controller
{
    ...
    {
        return view('admin.cms.background_image.create');
    }

    public function create_logo()
    {
        return view('admin.cms.logo.create');
    }
    ...
    public function leaderboard_index()
    {
        ...
        return view('admin.cms.background_image.leaderboard.index', [
            'cmsbgims' => $cmdbgims,
        ]);
    }
    ...
    public function play_index()
    {
        ...
        return view('admin.cms.background_image.play.index', [
            'cmsbgims' => $cmdbgims,
        ]);
    }
    ...
    public function announcement_index()
    {
        ...
        return view('admin.cms.background_image.announcement.index', [
            'cmsbgims' => $cmdbgims,
        ]);
    }
    ...
    public function stalk_index()
    {
        ...
        return view('admin.cms.background_image.stalk.index', [
            'cmsbgims' => $cmdbgims,
        ]);
    }
    ...
    public function splash_index()
    {
        ...
        return view('admin.cms.background_image.splash.index', [
            'cmsbgims' => $cmdbgims,
        ]);
    }
    ...
    public function login_index()
    {
        ...
        return view('admin.cms.background_image.login.index', [
            'cmsbgims' => $cmdbgims,
        ]);
    }
    ...
    public function logo_index()
    {
        ...
        return view('admin.cms.logo.index', [
            'cmsbgims' => $cmdbgims,
        ]);
    }
}
