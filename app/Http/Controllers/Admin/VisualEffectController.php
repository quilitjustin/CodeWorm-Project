...
class VisualEffectController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.game.effects.vfx.index', [
            'vfxs' => $vfxs,
        ]);
    }
    ...
    {
        //
        return view('admin.game.effects.vfx.create');
    }
    ...
    public function show($vfx)
    {
        ...
        return view('admin.game.effects.vfx.show', [
            'vfx' => $data,
        ]);
    }
    ...
    public function edit($vfx)
    {
        ...
        return view('admin.game.effects.vfx.edit', [
            'vfx' => $vfx,
        ]);
    }
