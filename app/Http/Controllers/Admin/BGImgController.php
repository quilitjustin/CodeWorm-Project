...
class BGImgController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.game.background_image.index', [
            'bgims' => $bgims,
        ]);
    }
    ...
    {
        //
        return view('admin.game.background_image.create');
    }
    ...
    public function show($bgim)
    {
        ...
        return view('admin.game.background_image.show', [
            'bgim' => $data,
        ]);
    }
    ...
    public function edit($bgim)
    {
        ...
        return view('admin.game.background_image.edit', [
            'bgim' => $data,
        ]);
    }
