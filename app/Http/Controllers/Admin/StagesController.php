...
class StagesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.game.stages.index', [
            'stages' => $stages,
        ]);
    }
    ...
    public function create()
    {
        ...
        return view('admin.game.stages.create', [
            'proglangs' => $proglangs,
            'rewards' => $rewards,
            'bgims' => $bgims,
            'bgms' => $bgms,
    ...
    public function show($stage)
    {
        ...
        return view('admin.game.stages.show', [
            'stage' => $data,
            'tasks' => $tasks,
        ]);
    }
    ...
    public function edit($stage)
    {
        ...
        return view('admin.game.stages.edit', [
            'stage' => $data,
            'proglangs' => $proglangs,
            'rewards' => $rewards,
            'tasks' => $tasks,
